...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, Rocket } from 'lucide-react';
...
export default function LoginPage({ onLogin, onBack, onSwitchToRegister, onGuestPlay }: LoginPageProps) {
  ...
  const handleSocialLogin = (provider: 'google' | 'facebook') => {
    ...
    setTimeout(() => {
      ...
      onLogin(socialEmail, 'social-login');
      setIsLoading(false);
    }, 1500);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to continue your space adventure</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="w-4 h-4 text-cyan-400 bg-slate-700 border-slate-600 rounded focus:ring-cyan-400 focus:ring-2" />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg font-semibold hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 shadow-lg hover:shadow-cyan-400/25 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
